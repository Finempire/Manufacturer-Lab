    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                ...
                <Link href="/dashboard/manager/expense-requests/new" className="inline-flex items-center gap-2 px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {loading ? (
                            ...
                            <tr key={exp.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-4 py-3 text-center"><Link href={`/dashboard/manager/expense-requests/${exp.id}`} className="text-blue-600 hover:text-blue-800"><Eye className="w-4 h-4 mx-auto" /></Link></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
