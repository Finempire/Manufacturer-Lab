                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-surface-1 rounded-lg border border-border overflow-hidden flex flex-col sm:flex-row">
                        <div className="flex-1 p-5 border-b sm:border-b-0 sm:border-r border-border-secondary bg-surface-2">
                            <p className="text-xs text-foreground-tertiary uppercase tracking-wider font-bold mb-1">Order Value</p>
                            <p className="text-2xl font-bold text-foreground">₹{order.total_amount.toLocaleString("en-IN", { minimumFractionDigits: 2 })}</p>
                        </div>
                        <div className="flex-1 p-5 bg-orange-50/30">
                            ...
                            <p className="text-xs text-foreground-tertiary mt-1">{order.expenses.length} expense request(s)</p>
                        </div>
                    </div>
