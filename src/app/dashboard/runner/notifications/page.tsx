        ...
        <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <div className="space-y-2">
                {loading ? (
                    ...
                    <div key={n.id} className={`bg-white rounded-xl border p-4 transition ${n.is_read ? "border-gray-200" : "border-blue-200 bg-blue-50/30"}`}>
                        <div className="flex items-start justify-between gap-3">
                            ...
                            {!n.is_read && (
                                <button onClick={() => markRead(n.id)} className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition" title="Mark as read">
