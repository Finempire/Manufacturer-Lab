    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-3">
                <Link href={`/dashboard/accountant/orders/${orderId}`} className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
                    <ArrowLeft className="w-5 h-5" />
                </Link>
                <div>
                    <h1 className="text-xl font-bold text-gray-900">Edit Order</h1>
                    <p className="text-sm text-gray-500">{orderNo}</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-xl border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" readOnly className="w-full h-9 px-3 bg-gray-100 border border-gray-300 rounded-lg text-sm text-gray-500 cursor-not-allowed" value={orderNo} />
                    </div>
                    <div>
                        ...
                        <table className="min-w-full divide-y divide-gray-200" style={{ tableLayout: "fixed" }}>
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th style={{ width: 32 }} className="px-3 py-2 text-center text-xs font-medium text-gray-500 uppercase">x</th>
                                </tr>
                            </thead>
