            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg border border-slate-200 p-6 space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select required className="w-full h-10 px-3 border border-slate-300 rounded-lg text-sm" value={form.buyer_id} onChange={e => setForm({ ...form, buyer_id: e.target.value })}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" required className="w-full h-10 px-3 border border-slate-300 rounded-lg text-sm" placeholder="₹0.00" value={form.expected_amount} onChange={e => setForm({ ...form, expected_amount: e.target.value })} />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select className="w-full h-10 px-3 border border-slate-300 rounded-lg text-sm" value={form.style_id} onChange={e => setForm({ ...form, style_id: e.target.value })}>
                ...
                {form.expense_category === "JOB_WORK" && (
                    <div>
                        <label className="block text-xs font-medium text-slate-700 mb-1">Job Work Type</label>
                        <input type="text" className="w-full h-10 px-3 border border-slate-300 rounded-lg text-sm" placeholder="e.g. Embroidery, Printing" value={form.job_work_type} onChange={e => setForm({ ...form, job_work_type: e.target.value })} />
                    </div>
                )}
