    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-lg font-semibold tracking-tight text-slate-900">User Management</h1>
                    <p className="text-sm text-slate-500 mt-1">Manage system accounts and roles</p>
                </div>
                <button
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
                {roles.map((role) => (
                    <div key={role} className="bg-white px-4 py-3 rounded-lg border border-slate-200">
                        <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-wider truncate">
                            {role.replace("_", " ")}
                        </p>
                        <p className="text-lg font-semibold tracking-tight text-slate-900 mt-1">{roleStats[role] || 0}</p>
                    </div>
                ))}
            </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-slate-200 flex flex-col sm:flex-row gap-4">
                ...
                <select
                    ...
                    className="w-full sm:w-48 px-3 py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                >
                ...
                <select
                    ...
                    className="w-full sm:w-32 px-3 py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                >
