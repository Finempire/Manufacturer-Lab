    ...
    return (
        <div className="space-y-4">
            <div>
                ...
                <p className="text-sm text-gray-500 mt-1">{payments.length} payments &bull; ₹{totalPaid.toLocaleString("en-IN")} total disbursed</p>
            </div>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {loading ? (
                            ...
                            <tr key={p.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-4 py-3 text-sm text-gray-500 text-right tabular-nums">₹{p.purchase.invoice_amount.toLocaleString("en-IN")}</td>
