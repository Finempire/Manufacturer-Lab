                    ...
                    <tbody className="divide-y divide-gray-100">
                        {vendors.map((v) => (
                            <tr key={v.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-4 py-3 text-sm text-gray-500">{v.contact_person} {v.phone ? `(${v.phone})` : ""}</td>
                                <td className="px-4 py-3 text-sm text-gray-500 font-mono">{v.gstin || "—"}</td>
                    ...
                    <div className="bg-white rounded-xl shadow-xl max-w-lg w-full mx-4 p-6" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" className="w-full h-10 px-3 border border-gray-300 rounded-lg text-sm" value={form.gstin} onChange={(e) => setForm({ ...form, gstin: e.target.value })} />
                            </div>
