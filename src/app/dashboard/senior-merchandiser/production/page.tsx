                    ...
                    <tbody className="divide-y divide-border-secondary">
                        {loading ? (
                            ...
                            <tr key={order.id} className="hover:bg-surface-2">
                                ...
                                <td className="px-4 py-3 text-center"><Link href={`/dashboard/senior-merchandiser/orders/${order.id}`} className="text-blue-600 hover:text-blue-800"><Eye className="w-4 h-4 mx-auto" /></Link></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
