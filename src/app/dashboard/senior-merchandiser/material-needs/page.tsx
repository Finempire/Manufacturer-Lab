    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                ...
                <Link href="/dashboard/senior-merchandiser/material-needs/new" className="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm">
                    ...
                    <tbody className="divide-y divide-border-secondary">
                        {loading ? (
                            ...
                            <tr key={req.id} className="hover:bg-surface-2">
                                ...
                                <td className="px-4 py-3 text-center"><Link href={`/dashboard/senior-merchandiser/material-needs/${req.id}`} className="text-blue-600 hover:text-blue-800"><Eye className="w-4 h-4 mx-auto" /></Link></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
