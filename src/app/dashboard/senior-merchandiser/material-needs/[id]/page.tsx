    ...
    return (
        <div className="space-y-6 max-w-3xl mx-auto pb-10">
            <div className="flex items-center gap-4">
                ...
                <span className={`px-3 py-1.5 text-xs font-bold uppercase tracking-wider rounded-md border ${STATUS_COLORS[req.status] || "bg-surface-3 text-foreground border-border"}`}>{req.status.replace(/_/g, " ")}</span>
            </div>
            ...
            <div className="bg-surface-1 rounded-lg border border-border p-5">
                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-6">
                    ...
                    {req.special_instructions && <div className="col-span-2"><p className="text-xs text-foreground-tertiary mb-1">Instructions</p><p className="text-sm text-foreground-secondary">{req.special_instructions}</p></div>}
                </div>
            </div>
            ...
            <div className="bg-surface-1 rounded-lg border border-border overflow-hidden">
                <div className="px-5 py-3 border-b border-border-secondary bg-surface-2"><h3 className="text-sm font-bold text-foreground uppercase tracking-wide">Material Lines</h3></div>
