...
export default function ProductionDashboard() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-xl font-bold text-gray-900">Production Manager Dashboard</h1>
                <p className="text-sm text-gray-500 mt-1">Order management and production workflow</p>
            </div>
