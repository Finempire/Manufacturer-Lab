...
export default function SamplePMOrdersPage() {
    ...
    return (
        <div className="space-y-4">
            <div>
                <h1 className="text-lg font-semibold tracking-tight text-slate-900">Sample Orders</h1>
                    ...
                    <tbody className="divide-y divide-slate-100">
                        {loading ? (
                            ...
                            <tr><td colSpan={6} className="px-4 py-12 text-center">
                                ...
                                <p className="text-sm text-slate-500">No sample orders assigned</p>
                            </td></tr>
                        ) : orders.map(order => (
                            <tr key={order.id} className="hover:bg-slate-50">
                                ...
                                <td className="px-4 py-3 text-sm text-slate-600">{order.merchandiser?.name || "—"}</td>
