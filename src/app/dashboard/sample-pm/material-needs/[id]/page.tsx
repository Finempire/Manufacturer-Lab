    ...
    return (
        <div className="space-y-6 max-w-3xl mx-auto pb-10">
            <div className="flex items-center gap-4">
                ...
                <span className={`px-3 py-1.5 text-xs font-bold uppercase tracking-wider rounded-md border ${STATUS_COLORS[req.status] || "bg-slate-100 text-slate-800 border-slate-200"}`}>{req.status.replace(/_/g, " ")}</span>
            </div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-5">
                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-6">
                    ...
                    {req.special_instructions && <div className="col-span-2"><p className="text-xs text-slate-500 mb-1">Instructions</p><p className="text-sm text-slate-700">{req.special_instructions}</p></div>}
                </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
                <div className="px-5 py-3 border-b border-slate-100 bg-slate-50"><h3 className="text-sm font-bold text-slate-900 uppercase tracking-wide">Material Lines</h3></div>
