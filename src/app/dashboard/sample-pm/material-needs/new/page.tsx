        ...
        <div className="max-w-3xl mx-auto pb-10">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="date" required className="w-full h-10 px-3 border border-gray-300 rounded-lg text-sm max-w-xs" value={form.required_by_date} onChange={e => setForm({ ...form, required_by_date: e.target.value })} />
                </div>
                ...
                <div className="space-y-3">
                    ...
                    {lines.map((line, i) => (
                        <div key={i} className="grid grid-cols-12 gap-2 items-center">
                            <input type="text" required placeholder="Material *" className="col-span-4 h-9 px-3 border border-gray-300 rounded-lg text-sm" value={line.material_name} onChange={e => handleLineChange(i, "material_name", e.target.value)} />
