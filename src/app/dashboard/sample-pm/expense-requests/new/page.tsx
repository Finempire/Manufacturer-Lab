            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select required className="w-full h-10 px-3 border border-gray-300 rounded-lg text-sm" value={form.order_id} onChange={e => setForm({ ...form, order_id: e.target.value })}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" required className="w-full h-10 px-3 border border-gray-300 rounded-lg text-sm" value={form.expected_amount} onChange={e => setForm({ ...form, expected_amount: e.target.value })} />
                    </div>
                </div>
